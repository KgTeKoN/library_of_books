...
describe('validate schema registration', () => {
    ...
    test('try invalid username (is not be empty)', async () => {
        ...
        await expect(signUpSchema.validateAsync(obj2)).rejects.toThrow(
    ...
    test('try invalid username (must be a string)', async () => {
        ...
        await expect(signUpSchema.validateAsync(obj3)).rejects.toThrow(
    ...
    test('try invalid first_name (length must be at least 3 characters long)', async () => {
        ...
        await expect(signUpSchema.validateAsync(obj4)).rejects.toThrow(
    ...
    test('try invalid first_name (must be a string)', async () => {
        ...
        await expect(signUpSchema.validateAsync(obj5)).rejects.toThrow(
    ...
    test('try invalid first_name (must only contain alpha-numeric characters)', async () => {
        ...
        await expect(signUpSchema.validateAsync(obj6)).rejects.toThrow(
            '"first_name" must only contain alpha-numeric characters'
        );
    });
    ...
    test('try invalid first_name (is not be empty)', async () => {
        ...
        await expect(signUpSchema.validateAsync(obj7)).rejects.toThrow(
    ...
    test('try invalid password (must be a string)', async () => {
        ...
        await expect(signUpSchema.validateAsync(obj8)).rejects.toThrow(
    ...
    test('try invalid password (length must be at least 6 characters long)', async () => {
        ...
        await expect(signUpSchema.validateAsync(obj9)).rejects.toThrow(
    ...
    test('try invalid password (is not be empty)', async () => {
        ...
        await expect(signUpSchema.validateAsync(obj10)).rejects.toThrow(
